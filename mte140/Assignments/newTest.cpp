...
class CircularLinkedList {
    ...
    //searching every occurance of the target
        ...
        if (head == NULL) {
          ...
          if (appearences==0){
            cout<<"No appearences of "<<target<<" found."<<endl;
          }
...
int main(){
  ...
  //Testing search function with no data in the list
  linked_list.searchList(9);
  
  //Testing delete function with no data in the list
  linked_list.deleteElement(6);
  
  linked_list.TailInsert(5);
  
  //Testing search function with 1 node in the list
  linked_list.searchList(5);
  
  //Testing delete function with 1 node in the list
  linked_list.deleteElement(5);
  
  linked_list.TailInsert(5);
  linked_list.TailInsert(6);
  
  //Testing search function with data that is not in the list
  linked_list.searchList(7);
  
  //Testing delete function with data that is not in the list
  linked_list.deleteElement(7);
